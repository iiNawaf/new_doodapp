      ...
      appBar: PreferredSize(
        ...
        child: ApplicationBar(
          isCategoryCommunities: true,
           title: '${currentCategory.title[0].toUpperCase()}${currentCategory.title.substring(1)}'
           ),
      ),
                ...
                child: GestureDetector(
                  onTap: () => Navigator.of(context).push(MaterialPageRoute(
                      builder: (context) => CommunityChatScreen(
                          community: communityProvider.communityList[index]))),
                  child: Container(
                            ...
                            Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                      "[${communityProvider.communityList[index].categoryTitle}]${communityProvider.communityList[index].bio}",
                                      overflow: TextOverflow.ellipsis,
                                      style: TextStyle(
