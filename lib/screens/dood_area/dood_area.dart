  ...
  Widget build(BuildContext context) {
    ...
    return RefreshIndicator(
      ...
      : Padding(
        ...
        ? Text("No doods yet.", style: TextStyle(color: titleColor),) 
        : ListView.builder(
                ...
                children: [
                  Row(
                    ...
                    children: [
                      ...
                      FlagDooder(id: doodProvider.doods[index].id,),
                      
                    ],
                  ),
                  DooderContent(content: doodProvider.doods[index].content,),
                  Align(
                    alignment: Alignment.centerRight,
                    child: DooderTime(time: doodProvider.doods[index].sendTime,),
                  ),
                ],
              ),
            ),
