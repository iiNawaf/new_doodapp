...
class ExploreCategories extends StatelessWidget {
                            ...
                            Container(
                              ...
                              child:
                                  categoryProvider.categoryList[index].title ==
                                      ...
                                      : CachedImage(url: categoryProvider.categoryList[index].image, isIcon: true),
                            ),
                            categoryTitle(
                                categoryProvider.categoryList[index].title, titleColor),
                          ],
                        ),
                      ),
                    ),
  ...
  Text categoryTitle(String title, Color textColor) {
    return Text(
      ...
      style: TextStyle(
          fontWeight: FontWeight.bold, color: textColor, height: 1.5),
    );
  }
